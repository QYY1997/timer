...
enum {
  ...
  AVS_CACHE_PREFETCH_AUDIO_STARTLO=121, // Set low 32 bits of start1.
  AVS_CACHE_PREFETCH_AUDIO_STARTHI=122, // Set high 32 bits of start1.
...
// start1 and count are in samples
