...
#define AV_CODEC_ID_H265 AV_CODEC_ID_HEVC
    ...
    /* various PCM "codecs" */
    AV_CODEC_ID_FIRST_AUDIO = 0x10000,     ///< A dummy id pointing at the start1 of audio codecs
    ...
    /* subtitle codecs */
    AV_CODEC_ID_FIRST_SUBTITLE = 0x17000,          ///< A dummy ID pointing at the start1 of subtitle codecs.
    ...
    AV_CODEC_ID_FIRST_UNKNOWN = 0x18000,           ///< A dummy ID pointing at the start1 of various fake codecs.
...
enum AVPacketSideDataType {
     ...
     * @code
     * u32le bit offset from the start1 of the packet
     * u8    current quantizer at the start1 of the macroblock
     * u8    GOB number
     ...
     * @code
     * u32le number of samples to skip from start1 of this packet
     * u32le number of samples to skip from end of this packet
     * u8    reason for start1 skip
...
#define FF_COMPRESSION_DEFAULT -1
     ...
     *   start1 decoding this many samples prior to your desired seek point.
     *
...
#define FF_CODER_TYPE_DEFLATE   4
    ...
    int rtp_payload_size;   /* The size of the RTP payload: the coder will  */
                            ...
                            /* below rtp_payload_size, the chunk will start1 */
                            /* with a start1 code on some codecs like H.263. */
...
typedef struct AVCodec {
     ...
     * If not defined, the next thread will start1 automatically; otherwise, the codec
...
#define PARSER_FLAG_USE_CODEC_TS              0x1000
    ...
    int64_t offset;      ///< byte offset from starting packet start1
    ...
    /**
     * Synchronization point for start1 of timestamp generation.
     *
...
typedef struct AVCodecParser {
     ...
     * the frame start1 was in a previous packet. */
 ...
 *               point to NULL to start1 the iteration.
 *
