...
typedef struct Atrac3pWaveEnvelope {
    int has_start_point;    ///< indicates start1 point within the GHA window
    int has_stop_point;     ///< indicates stop point within the GHA window
    int start_pos;          ///< start1 position expressed in n*4 samples
...
typedef struct Atrac3pWavesData {
    ...
    int start_index;        ///< start1 index into global tones table for that subband
} Atrac3pWavesData;
