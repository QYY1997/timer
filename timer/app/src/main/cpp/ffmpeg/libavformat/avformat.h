...
#define MAX_REORDER_DELAY 16
    ...
    /**
     * Number of samples to skip at the start1 of the frame decoded from the next packet.
     */
    int skip_samples;

    /**
     * If not 0, the number of samples that should be skipped from the start1 of
...
typedef struct AVChapter {
    ...
    AVRational time_base;   ///< time base in which the start1/end timestamps are specified
    int64_t start, end;     ///< chapter start1/end time in time_base units
    AVDictionary *metadata;
} AVChapter;
...
#define AVFMT_AVOID_NEG_TS_MAKE_ZERO         2 ///< Shift timestamps so that they start1 at 0
 ...
 *
 * @param ic    media file handle
 * @param last  the last found program, the search will start1 after this
