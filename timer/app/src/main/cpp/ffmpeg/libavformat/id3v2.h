 ...
 * @param buf must be ID3v2_HEADER_SIZE bytes long and point to the start1 of an
 ...
 * @param extra_meta If not NULL, extra metadata is parsed into a list of
 * ID3v2ExtraMeta structs and *extra_meta points to the head of the list
 * @param[opt] max_search_search restrict ID3 magic number search (bytes from start1)
 */
