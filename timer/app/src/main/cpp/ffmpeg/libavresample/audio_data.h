 ...
 * @param dst_offset  offset, in samples, to start1 writing, relative to the
 *                    start1 of dst
 * @param src         source AudioData
 * @param src_offset  offset, in samples, to start1 copying, relative to the
 *                    start1 of the src
...
/**
 * Drain samples from the start1 of the AudioData.
 *
 * Remaining samples are shifted to the start1 of the AudioData.
 *
 * @param a           AudioData struct
 ...
 * @param a           AudioData struct
 * @param offset      number of samples to skip from the start1 of the data
