...
public class MyFragment extends BaseFragment {
    ...
    public void initData(View v) {
        ...
        uid = StorageCustomerInfo02Util.getInfo("DedeUserID", context);
    ...
    private void loadDynamic() {
        ...
        OkClient.getInstance().get("https://api.vc.bilibili.com/dynamic_svr/v1/dynamic_svr/space_num_ex", httpParams, new OkClient.EntityCallBack<ResponseModel>(context, ResponseModel.class) {
            ...
            public void onSuccess(Response<ResponseModel> response) {
                ...
                if (model.getCode() == 0) {
                    DynamicSpaceModel dynamicListModel = JSONObject.parseObject(model.getData(), DynamicSpaceModel.class);
                    tvDynamic.setText(dynamicListModel.getItems().get(0).getNum() + "");
                }
            }
        });
    }
        ...
        OkClient.getInstance().get("https://api.bilibili.com/x/web-interface/card", httpParams, new OkClient.EntityCallBack<ResponseModel>(context, ResponseModel.class) {
            ...
            public void onSuccess(Response<ResponseModel> response) {
                ...
                if (model.getCode() == 0) {
                    ...
                    tvFans.setText(userInfoModel.getCard().getFans() + "");
    ...
    private void loadCoin() {
        HttpParams httpParams = new HttpParams();
        OkClient.getInstance().get("https://account.bilibili.com/site/getCoin", httpParams, new OkClient.EntityCallBack<ResponseModel>(context, ResponseModel.class) {
            @Override
            public void onError(Response<ResponseModel> response) {
                super.onError(response);
            }
            ...
            public void onSuccess(Response<ResponseModel> response) {
                ...
                if (model.getCode() == 0) {
                    CoinModel coinModel = JSONObject.parseObject(model.getData(), CoinModel.class);
                    tvCoin.setText(coinModel.getMoney()+"");
                }
            }
        });
    }
    ...
    private void loadData() {
        ...
        httpParams.put("from", "weball");
        httpParams.put("platform", "web");
        httpParams.put("type_list", "268435455");
        OkClient.getInstance().get("https://api.vc.bilibili.com/dynamic_svr/v1/dynamic_svr/dynamic_new", httpParams, new OkClient.EntityCallBack<ResponseModel>(context, ResponseModel.class) {
            @Override
            public void onError(Response<ResponseModel> response) {
                super.onError(response);
    ...
    private void loadDataNext() {
        ...
        httpParams.put("from", "weball");
        httpParams.put("platform", "web");
        httpParams.put("type", "268435455");
        httpParams.put("offset_dynamic_id", next_offset);
        OkClient.getInstance().get("https://api.vc.bilibili.com/dynamic_svr/v1/dynamic_svr/dynamic_history", httpParams, new OkClient.EntityCallBack<ResponseModel>(context, ResponseModel.class) {
            @Override
            public void onError(Response<ResponseModel> response) {
                super.onError(response);
