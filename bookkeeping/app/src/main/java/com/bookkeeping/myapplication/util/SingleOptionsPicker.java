...
import com.bookkeeping.myapplication.model.SuccessCallback;
...
public class SingleOptionsPicker<T> {
     ...
     * 普通条件选择项方法
     */
    public SingleOptionsPicker(Activity activity, int options1, List<T> options1Items, OnPickerOptionsClickListener listener) {
        this.activity = activity;
        this.listener = listener;
        this.options1Items = options1Items;
    ...
    public void openOptionsPicker(Activity activity, List<String> list, final int type, final TextView textView) {
